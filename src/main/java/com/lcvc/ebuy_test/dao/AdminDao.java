package com.lcvc.ebuy_test.dao;

import com.lcvc.ebuy_test.model.Admin;
...
public class AdminDao {
	...
	public static void main(String[] args) {
		...
		/*System.out.println(adminDao.login("admin", "12345"));
		...
		System.out.println(adminDao.getAdmin("5485485"));
	}
}
